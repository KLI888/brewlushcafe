      ...
      >
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <Link
              to="/gallery"
              className="inline-flex items-center justify-center rounded-full border border-border bg-background px-8 py-4 text-lg font-body font-semibold text-foreground hover:bg-muted transition-colors duration-300"
            >
              View Gallery
            </Link>
          </div>
